# Implementation Prompt for RFC-004: Team and Member Management
...
## Context
This implementation covers RFC-004, which focuses on full CRUD for teams and team members: create team form, add/edit/delete member forms with working-day toggles, member list view, and all backing API routes. This RFC provides the core data entities that sprint capacity calculations and issue tables depend on. Please refer to the following documents:
...
## Scope Limitation
Please only implement the features specified in @RFC-004.md. If you identify dependencies on features from other RFCs, note them but do not implement them unless explicitly instructed.
